...
void loop() {
  pixels_low.setBrightness(bright);
  ...
  if (distance_top > 600) //상판 초음파센서와 수면까지 거리
  {
    if (distance4 <= 400) //초음파센서 4번 높이에 컵 걸렸을때
    {
      if (distance1 < 400) //컵을 올려놨을 때
      {
        //Serial.println("큰컵물나와라");
  ...
  //////////////////////////////////////////////////////////////////////mp3나오기
  else if (distance_top <= 600) //상판 초음파센서와 수면까지 거리가 100보다 작거나 같을때 작동 멈추게
  {
    if (distance4 <= 400) //초음파센서 4번 높이에 컵 걸렸을때
    {
      if (distance1 < 400) //컵을 올려놨을 때
  ...
  if (distance_top > 800 ) ////상판 초음파센서와 수면까지 거리가 175보다 클때 작동되게
  {
    if (distance4 > 300 && distance3 <= 400)
    {
      if (distance1 < 400) //컵을 올려놨을 때
      {
        //Serial.println("중간컵물나와라");
        myservo.write(180);
        //////////////////////////////////////////////////////////////////////펌프 작동
        for (int i = 0; i < NUMPIXELS_high; i++) {
          // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
  ...
  else if (distance_top <= 800) //상판 초음파센서와 수면까지 거리
  {
    if (distance4 > 300 && distance3 <= 400)
    {
      if (distance1 < 400) //컵을 올려놨을 때
      {
        //Serial.println("중간컵물x");
        myservo.write(90);
        //////////////////////////////////////////////////////////////////////펌프 종료
        for (int i = 0; i < NUMPIXELS_high; i++) {
          pixels_high.setPixelColor(i, pixels_high.Color(127, 229, 229));
  ...
  if (distance_top > 1200) ////상판 초음파센서와 수면까지 거리가 200보다 클때 작동되게
  {
    if (distance4 > 300 && distance3 > 300 && distance2 <= 400)
    {
      if (distance1 < 400) //컵을 올려놨을 때
      {
        //Serial.println("종이컵물나와라");
        myservo.write(180);
        //////////////////////////////////////////////////////////////////////펌프 작동
        for (int i = 0; i < NUMPIXELS_high; i++) {
          // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
  ...
  else if (distance_top <= 1200) //상판 초음파센서와 수면까지 거리가 200보다 작거나 같을때 작동 멈추게
  {
    if (distance4 > 400 && distance3 > 400 && distance2 <= 400)
    {
      if (distance1 < 400) //컵을 올려놨을 때
      {
        //Serial.println("종이컵물x");
        myservo.write(90);
        //////////////////////////////////////////////////////////////////////펌프 종료
        for (int i = 0; i < NUMPIXELS_high; i++) {
          pixels_high.setPixelColor(i, pixels_high.Color(127, 229, 229));
  ...
  /*else if (distance_top > 220) ////상판 초음파센서와 수면까지 거리가 220보다 클때 작동되게  // 제일 작은 컵 검사
    {
    if (distance1 < 300) //컵을 올려놨을 때
    {
    myservo.write(180);
    //////////////////////////////////////////////////////////////////////펌프 작동
    for (int i = 0; i < NUMPIXELS_high; i++) {
  ...
  {
    {
      if (distance_mot < 2500)
      {
        pixels_low.setPixelColor(0, pixels_low.Color(127, 229, 229));
        pixels_low.setPixelColor(1, pixels_low.Color(127, 229, 229));
        pixels_low.setPixelColor(2, pixels_low.Color(127, 229, 229));
        pixels_low.setPixelColor(3, pixels_low.Color(127, 229, 229));
        pixels_low.setBrightness(200);
        // pixels_low.show(); // This sends the updated pixel color to the hardware.
      }
      else if (distance_mot >= 2500)
      {
